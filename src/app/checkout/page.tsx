      ...
      <div className="grid lg:grid-cols-3 gap-8 lg:gap-12">
        ...
        <div className="lg:col-span-2">
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="border rounded-xl p-5 sm:p-8 bg-white shadow-sm">
              <h2 className="text-lg sm:text-xl font-medium mb-5 sm:mb-6 flex items-center gap-2">
        ...
        <div className="lg:col-span-1">
          <div className="border border-gray-100 rounded-xl p-5 sm:p-6 bg-white shadow-sm sticky top-24">
            <h2 className="text-base sm:text-lg font-medium mb-5 sm:mb-6 flex items-center gap-2 border-b border-gray-100 pb-4">
            ...
            <div className="space-y-4 mb-5 sm:mb-6 max-h-[40vh] overflow-y-auto pr-1">
              {items.map((item) => (
                ...
                >
                  <div className="relative w-14 h-14 sm:w-16 sm:h-16 bg-gray-50 rounded-lg overflow-hidden shrink-0 border border-gray-100">
                    <Image
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="font-medium line-clamp-1 mb-1 text-xs sm:text-sm">{item.name}</p>
                    
                    {/* نمایش سایز و دایره رنگ */}
                    <div className="flex flex-wrap items-center gap-2 text-[11px] sm:text-xs text-gray-500 mb-1">
            ...
            <div className="space-y-3 sm:space-y-4 text-xs sm:text-sm border-t border-gray-100 pt-5 sm:pt-6">
              ...
              {total < 500000 && (
                <p className="text-[11px] sm:text-xs text-center text-[#BFA46F] bg-[#BFA46F]/10 p-2.5 rounded-lg leading-relaxed">
                  با خرید {(500000 - total).toLocaleString("fa-IR")} تومان دیگه، ارسال رایگان میشه!
                </p>
              )}
              <div className="flex justify-between border-t border-gray-100 pt-4 text-sm sm:text-base font-medium">
                <span>مبلغ قابل پرداخت</span>
                <span className="text-[#BFA46F] font-bold">
